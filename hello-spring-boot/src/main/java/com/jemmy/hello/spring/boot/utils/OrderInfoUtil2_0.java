...
import com.jemmy.hello.spring.boot.utils.SignUtils;
...
public class OrderInfoUtil2_0 {
	 ...
	 * 构造支付订单参数列表
	 */
	public static Map<String, String> buildOrderParamMap(String app_id, boolean rsa2, OrderVO order, String notify_url) {
		Map<String, String> keyValues = new HashMap<String, String>();

		keyValues.put("app_id", app_id);

		keyValues.put("biz_content", "{\"timeout_express\":\"30m\",\"product_code\":\"QUICK_MSECURITY_PAY\",\"total_amount\":"+order.getTotalPrice()+",\"subject\":\"1\",\"body\":\"我是测试数据\",\"out_trade_no\":\"" + order.getOrderNo() +  "\"}");
